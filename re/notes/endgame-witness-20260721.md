...
| ~54-85 | **DIÁLOGO DE LB** (en el panel de texto, paceado por tecla): «Didst thou bring my box?» → **fork Yes/No** («You reply: Yes») → «Lord British carefully opens the box...» → discurso largo (varias páginas): «...«that thee and I …» (67 B, sha1 199d1034 — recortado; verifica contra tu copia) …» (93 B, sha1 7f7bb418 — recortado; verifica contra tu copia)» / «...the Orb of the Moons!» |
